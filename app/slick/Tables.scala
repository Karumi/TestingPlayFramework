...
trait Tables {
  ...
  implicit def GetResultDevelopersRow(implicit e0: GR[String], e1: GR[Option[String]]): GR[DevelopersRow] = GR{
    prs => import prs._
  ...
  class DevelopersTable(_tableTag: Tag) extends profile.api.Table[DevelopersRow](_tableTag, Some("tpf"), "developers") {
  ...
  class FlywaySchemaHistoryTable(_tableTag: Tag) extends profile.api.Table[FlywaySchemaHistoryRow](_tableTag, Some("tpf"), "flyway_schema_history") {
